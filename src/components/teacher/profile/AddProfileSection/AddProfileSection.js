...
const AddProfileSection = (props) => {
  ...
  //save the change when add some information
    ...
    <div>
      <div className="more-section">
        ...
        <div className="btn-section">
          <button className="add-section" onClick={show}>
            Add Profile Section
          </button>
        </div>
        ...
        <div id="seciton-text" onLoad={showCurrentInfo}>
          <p id="about-title">
            ...
            <img
              ...
              onClick={enableEdit.bind(this, "about")}
              alt="edit-icon"
            ></img>
          </p>
          ...
          <button
            disabled={edit === "about" ? false : true}
            id="save-about"
            onClick={saveSections.bind(this, "About")}
          >
            Save
          </button>
          ...
          <p id="education-title">
            ...
            <img
              src={require("./images/edit.png")}
              onClick={enableEdit.bind(this, "education")}
              alt="edit-icon"
            ></img>
          </p>
          <textarea
          ...
          ></textarea>
          <button
            disabled={edit === "education" ? false : true}
            id="save-education"
            onClick={saveSections.bind(this, "Education")}
          >
            Save
          </button>
          ...
          <p id="skills-title">
            ...
            <img
              src={require("./images/edit.png")}
              onClick={enableEdit.bind(this, "skills")}
              alt="edit-icon"
            ></img>
          </p>
          <textarea
          ...
          ></textarea>
          <button
            disabled={edit === "skills" ? false : true}
            id="save-skills"
            onClick={saveSections.bind(this, "Skills")}
          >
            Save
          </button>
          ...
          <p id="workingEx-title">
            ...
            <img
              src={require("./images/edit.png")}
              onClick={enableEdit.bind(this, "workingEx")}
              alt="edit-icon"
            ></img>
          </p>
          <textarea
          ...
          ></textarea>
          <button
            disabled={edit === "workingEx" ? false : true}
            id="save-workingEx"
            onClick={saveSections.bind(this, "WorkingEx")}
          >
            Save
          </button>
          ...
          <p id="hobbies-title">
            ...
            <img
              src={require("./images/edit.png")}
              onClick={enableEdit.bind(this, "hobbies")}
              alt="edit-icon"
            ></img>
          </p>
          <textarea
          ...
          ></textarea>
          <button
            disabled={edit === "hobbies" ? false : true}
            id="save-hobbies"
            onClick={saveSections.bind(this, "Hobbies")}
          >
            Save
          </button>
      ...
      <div id="dialog">
        <div id="content">
          ...
          <div id="section">
            <p id="about" onClick={showAbout}>
              About
            </p>
            <hr />
            <p id="education" onClick={showEducation}>
              Education
            </p>
            <hr />
            <p id="skills" onClick={showSkills}>
              Skills
            </p>
            <hr />
            <p id="working-ex" onClick={showWorkingEx}>
              Working experience
            </p>
            <hr />
            <p id="hobbies" onClick={showHobbies}>
              Hobbies
            </p>
          </div>
        </div>
